...
public class CartDAO {
	...
	public void addRow( int itemId, String itemName, String customerId, String pimage, int quantity, double price)throws Exception {
 
		
		// make a query
        String insertQuery = "Insert into cart (itemId,itemName,customerId,pimage,quantity,price) "
        		+ "values (?,?,?,?,?,?)";
	...
	public ArrayList<Cart> listCart(String customerId) throws Exception{
		...
		// make a query
		String selectQuery = "select cartNo, itemId, itemName, pimage, quantity, price from Cart where customerId ='" + customerId + "' ";
